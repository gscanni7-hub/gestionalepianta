    ...
    try {
      ...
      if (managed) {
        if (managed.status === 'approved') {
          ...
          setLoginError('Il tuo account è in attesa di approvazione.');
        } else {
          setLoginError('Il tuo account non è stato approvato.');
        }
        return;
      }
      ...
      setLoginError('Account creato con Google! In attesa di approvazione dall\'admin.');
    } catch (err: any) {
